...
> ⚠ ModはModrinth,Cursforgeからダウンロードします。お使いのMinecraftサーバーのバージョンやMod Loader（Fabric / Forge / Neoforge等）で正常に動作するとは限りません。必ずバックアップを取ってからご使用ください。
### Plugin
